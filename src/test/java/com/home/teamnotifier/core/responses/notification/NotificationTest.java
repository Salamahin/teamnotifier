...
//        final Notification userInfo = new Notification(isInfoWithActor(action) ? "user" : null, Instant.parse("2015-11-05T23:44:40.220Z"), action, 1, "details");
//        final String expected = MAPPER.writeValueAsString(
//                MAPPER.readValue(fixture(fixturePath), Notification.class)
//        );
...
//        final Notification person = new Notification(isInfoWithActor(action) ? "user" : null, Instant.parse("2015-11-05T23:44:40.220Z"), action, 1, "details");
//        assertThat(MAPPER.readValue(fixture(fixturePath), Notification.class))
//                .isEqualTo(person);
//    }
//
//    @Test
