...
public class NotifierModule extends AbstractModule {
  ...
  protected void configure() {
    bind(UserGateway.class).to(HardcodedUserGateway.class).in(Singleton.class);
  }
  ...
  @Provides
  @Singleton
  public ScheduledExecutorService newScheduledExecutorService(final NotifierConfiguration
      configuration) {
